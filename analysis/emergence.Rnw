...
the digitization of our lives has brought us large, available corpi
...
However, Schelling model also has the limitations that are typical of
agent-based modeling, at least within the sociological
literature. Schelling showed that the local action of households
acting on individual preferences could lead to the racial segregation
that resembled American cities. He did not, and with his tools, could
not show that this explanation was better than the alternative
explanations of legally enforced segregation, housing filtering, or
discrimination by banks, realtors, or developers.
...
households acting on with very mild
racist preferences in who they lived next to 
very mild racist preferences in 
